...
import bgImg from "@/assets/cards/tatoo-banner-bg.png";
import BgImage1 from "@/assets/cards/tatoo-removel.png";
  ...
  const data = [
    {
      ...
      description:
        "Most clients notice lightening after just a few sessions, with complete fading over time. Factors like ink color, depth, and age will influence results.",
    },
    {
      id: 2,
      title: "Maintaining Results",
      description:
        "Follow-up care and spacing sessions correctly ensures your skin heals safely and beautifully. Avoid sun exposure, follow product recommendations, and stay patient—true transformation takes time.",
    },
  ];
...
const page = () => {
  return (
    <>
      ...
      <DynamicImageSection img={BgImage1.src} isBox={true} />
      <FAQ />
      <Results />
      ...
      <Container>
        <DynamicHairRemoval
          title="Say Goodbye to the Past — Start Fresh Today"
          sub_title="Take the First Step Toward Clearer Skin"
