...
export default function page() {
  const { data, isLoading } = useConditionTreatedDetailsQuery("enlarged-pores");

  const sectionBars = [
    { id: 1, path: "Microneedling", label: "Microneedling" },
    { id: 2, path: "ChemicalPeels", label: "Chemical Peels" },
