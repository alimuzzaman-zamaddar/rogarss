...
export default function page() {
  const { data, error, isLoading, isUninitialized, status } =
    useConditionTreatedDetailsQuery("dull-or-dehydrated-skin");
  console.log(
    data,
    error,
    isLoading,
