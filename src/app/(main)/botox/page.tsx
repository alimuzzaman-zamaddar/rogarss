  ...
  return (
    <>
      ...
      <Container>
        <BannerSection
          bgImages={[
            "https://i.ibb.co.com/GfWj4k1w/botox.png",
            "https://i.ibb.co.com/GfWj4k1w/botox.png",
            "https://i.ibb.co.com/GfWj4k1w/botox.png",
          ]}
          heading="Botox"
      ...
      <div className="pt-10 lg:pt-14 2xl:pt-20 3xl:pt-30 pb-5 xl:pb-8 2xl:pb-10">
        <Container>
          ...
          >
            At Esteves Aesthetics, Botox is more than just a treatment it’s a
            way to help you look refreshed, confident, and naturally beautiful.
            Our expert injectors use advanced techniques to smooth fine lines
            and wrinkles, while preserving your unique facial expressions for
            results that feel authentically you.
          </p>
          <p
            data-aos="fade-up"
          ...
          >
            Botox is one of the most popular and effective non-surgical
            treatments for reducing fine lines and wrinkles, helping you achieve
            a smoother, more youthful appearance. This FDA-approved injectable
            works by temporarily relaxing the underlying facial muscles that
            cause expression lines, such as frown lines, crow’s feet, and
            forehead creases. The result is a natural, refreshed look without
            the need for downtime or invasive procedures. The treatment is
            quick, typically taking just 10–15 minutes, and most patients can
            return to their normal activities immediately afterward. Botox not
            only softens existing lines but can also help prevent new wrinkles
            from forming, making it an excellent choice for both corrective and
            preventative care. Results generally become noticeable within a few
            days and can last three to four months, depending on individual
            factors. With precise application by skilled professionals, Botox
            delivers subtle, beautiful results that enhance your natural
