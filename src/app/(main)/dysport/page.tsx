    ...
    <>
      ...
      <div className="pt-10 lg:pt-14 2xl:pt-20 3xl:pt-30 pb-5 xl:pb-8 2xl:pb-10">
        <Container>
          ...
          >
            Dysport at Esteves Aesthetics
          </h4>
          <p
            data-aos="fade-up"
            className="text-center card_description w-[80%] mx-auto mb-10"
          >
            At Esteves Aesthetics, we are proud to offer Dysport, a highly
            effective injectable treatment designed to smooth fine lines and
            wrinkles while maintaining a natural look. As one of the most
            trusted wrinkle relaxers, Dysport works quickly and seamlessly to
            soften unwanted expression lines—giving you a refreshed and youthful
            appearance without altering your natural expressions.
          </p>
          <p
            data-aos="fade-up"
            className="text-center card_description w-[80%] mx-auto "
          >
            Our expert providers specialize in customizing each Dysport
            treatment to your unique features, ensuring results that are subtle,
            balanced, and confidence-boosting. Whether you’re concerned about
            frown lines, forehead creases, or crow’s feet, Dysport is a proven
            solution for achieving radiant, natural-looking results.
          </p>
        </Container>
      ...
      <DynamicCardSection
        image1={image4}
        image2={image10}
        title="The Science Behind Smoother Skin"
        description="Dysport is an FDA-approved injectable treatment designed to temporarily relax specific facial muscles that cause wrinkles and fine lines. It works by targeting the underlying muscle activity responsible for dynamic wrinkles—those that appear when you frown, squint, or raise your eyebrows. By reducing this activity, Dysport smooths the skin’s surface, helping you achieve a softer, more youthful appearance without altering your natural expressions.

     At Esteves Aesthetics, we use Dysport to treat common areas such as forehead lines, frown lines (glabellar lines), and crow’s feet, delivering results that are both subtle and long-lasting. Most patients notice improvements within just a few days, with effects that can last up to four months, making it a convenient and effective solution for maintaining a refreshed, confident look.
     "
      ...
      <Container>
        ...
        <p
          ...
          className="text-center card_description w-[80%} mx-auto"
        >
          Dysport and Botox are both popular injectable treatments designed to
          smooth wrinkles and fine lines by temporarily relaxing targeted facial
          muscles. While they work in similar ways, there are subtle differences
          that may make one more suitable for your unique goals. Dysport tends
          to spread more easily, making it an excellent choice for larger
          treatment areas like the forehead, while Botox offers precise
          targeting for smaller, more defined lines. The right option depends on
          your skin concerns, desired results, and how your body responds to
          each formula. At Esteves Aesthetics, our experienced team will guide
          you through the decision process, ensuring you receive a treatment
          plan that delivers the most natural, rejuvenating results possible.
        </p>
      </Container>
      ...
      <Container>
        <div className="my-35">
          ...
          >
            Botox is an excellent option for individuals looking to reduce the
            appearance of fine lines and wrinkles caused by repetitive facial
            expressions, such as frowning, squinting, or smiling. Ideal
            candidates are generally healthy adults who wish to achieve a
            smoother, more refreshed look without surgery or extensive downtime.
            It is particularly effective for treating crow’s feet, forehead
            lines, and frown lines between the brows. Botox may also be suitable
            for those seeking to prevent the early signs of aging before
            wrinkles become deeply set. However, individuals who are pregnant,
            breastfeeding, or have certain neurological conditions should avoid
            Botox.
          </p>
        </div>
      </Container>
      ...
      <Container>
        <div className="my-35 flex gap-10 px-30">
          ...
          <p data-aos="fade-up" className="section_description  flex-1">
            At Esteves Aesthetics, the Botox procedure is quick, precise, and
            designed for your comfort. After a brief consultation to confirm
            your treatment plan, your provider will cleanse the area and may
            apply a topical numbing cream if desired. Using an ultra-fine
            needle, small amounts of Botox are carefully injected into the
            targeted muscles.
          </p>
        </div>
      </Container>
