...
import { DynamicCardSectionAboutProps } from "@/types/api";

const DynamicCardSectionAbout = ({
  id,
  image1,
  image2,
  title,
          ...
          <div className="flex-1 w-full 3xl:w-[45%] flex relative">
            ...
            >
              <div className="hidden xl:block">
                <Image
                  className="h-[500px] 2xl:h-[800px] w-[260px] object-cover"
                  src={image1}
                  alt="contact image 1"
                />
              </div>
            ...
            <div
              data-aos="fade-up"
              className={`xl:pt-20 z-20 w-full ${
...
export default DynamicCardSectionAbout;
